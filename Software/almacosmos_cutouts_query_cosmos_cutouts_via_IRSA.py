...
Header_Caches = {
                ...
                'COSMOS_INT_UVISTA_J':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_UVISTA_J.header',  
                'COSMOS_INT_UVISTA_H':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_UVISTA_H.header',  
                'COSMOS_INT_UVISTA_K':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_UVISTA_K.header',  
                'COSMOS_INT_UVISTA_Y':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_UVISTA_Y.header',  
                'COSMOS_INT_IRAC_ch1':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_IRAC_ch1.header',  
                'COSMOS_INT_IRAC_ch2':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_IRAC_ch2.header',  
                'COSMOS_INT_IRAC_ch3':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_IRAC_ch3.header',  
                'COSMOS_INT_IRAC_ch4':  os.path.dirname(os.path.dirname(__file__))+os.sep+'Data'+os.sep+'cosmos_image_fits_header_files'+os.sep+'COSMOS_INT_IRAC_ch4.header',  
