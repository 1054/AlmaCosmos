...
if len(sys.argv)==1:
    print "\n gd2mjd.py converts a gregorian date to julian date."
    print "\n Usage: gd2mjd.py dd.mm.yyyy [hh:mm:ss.ssss]\n"
    sys.exit()
...
#<dzliu># print "Fractional day: %f" % fracday
