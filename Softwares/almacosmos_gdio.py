...
class CAAP_Google_Drive_Operator(object):
    ...
    def __init__(self):
        ...
        self.credential_dir = os.path.join(os.path.expanduser('~'), '.almacosmos')
    ...
    def get_credential(self):
        ...
        if not os.path.exists(self.credential_file):
            print('Error! Key "%s" was not found! Please ask A3COSMOS for the "Key_for_Google_Drive_from_A3COSMOS.json" then put it there!'%(self.credential_file))
            sys.exit()
