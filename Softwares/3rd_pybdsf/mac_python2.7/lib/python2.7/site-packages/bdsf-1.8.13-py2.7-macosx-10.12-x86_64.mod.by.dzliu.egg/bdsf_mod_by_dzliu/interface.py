...
def process(img, **kwargs):
    ...
    #<20180310><dzliu># 
    #<20180310><dzliu># change the default log file to be under current directory instead of image file directory
    #log = img.opts.filename + '.pybdsf.log'
    import os
    log = os.path.basename(img.opts.filename) + '.pybdsf.log'
    #<20180310><dzliu># 
    #<20180310><dzliu># 
    img.log = ''
