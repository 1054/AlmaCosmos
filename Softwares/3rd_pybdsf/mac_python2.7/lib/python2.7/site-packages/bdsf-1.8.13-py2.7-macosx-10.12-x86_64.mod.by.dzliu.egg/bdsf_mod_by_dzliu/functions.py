    ...
    for i in range(ngaus):
      ...
      if size[0] == 0.0 or size[1] == 0.0:
        ...
        try:
            ...
            e_pa = e_pa * 180.0/pi
            #<20180305><dzliu>#-------------------
            #<20180305><dzliu>#e_tot = pp[0] * sqrt(e_peak * e_peak / (pp[0] * pp[0]) + (0.25 / dumr / dumr) * (e_maj * e_maj / (size[0] * size[0]) + e_min * e_min / (size[1] * size[1])))
            #<20180305><dzliu>#-->replaced with-->
...
def read_image_from_file(filename, img, indir, quiet=False):
    ...
    if not quiet:
        mylogger.userinfo(mylog, "")                           #<20180305># Added by dzliu
        mylogger.userinfo(mylog, "*** bdsf_mod_by_dzliu ***")  #<20180305># Added by dzliu
        mylogger.userinfo(mylog, "")                           #<20180305># Added by dzliu
