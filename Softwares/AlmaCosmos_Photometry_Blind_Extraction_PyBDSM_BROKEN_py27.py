...
if platform.system() == 'Darwin':
    sys.path.insert(1,os.path.abspath(os.path.dirname(sys.argv[0]))+os.sep+'3rd_mac'+os.sep+'lib') # export DYLD_LIBRARY_PATH
    ...
    os.environ['PATH'] = os.path.abspath(os.path.dirname(sys.argv[0]))+os.sep+'3rd_mac'+os.sep+'lib' + ';' + os.environ['PATH']
    import ctypes
    ctypes.CDLL(os.path.abspath(os.path.dirname(sys.argv[0]))+os.sep+'3rd_mac'+os.sep+'lib'+os.sep+'libboost_python.dylib')
    ctypes.CDLL(os.path.abspath(os.path.dirname(sys.argv[0]))+os.sep+'3rd_mac'+os.sep+'lib'+os.sep+'libboost_python-mt.dylib')
else:
