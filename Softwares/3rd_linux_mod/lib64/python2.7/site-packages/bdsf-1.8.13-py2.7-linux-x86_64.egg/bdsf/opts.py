...
class Opts(object):
    ...
    src_radius_pix = Option(None, Float(),
                             doc = "Radius of the island (if src_ra_dec is not None) in pixels. "\
                                 ...
                                 "parameter.",
                             group = "advanced_opts")
    #<20171108><DZLIU># ini_gausfit = Enum('default', 'simple', 'nobeam',
    #<20171108><DZLIU>#                          doc = "Initial guess for Gaussian "\
    #<20171108><DZLIU>#                              "parameters: 'default', 'simple', or 'nobeam'\n"\
    #<20171108><DZLIU>#                              "These are three different ways of estimating the initial "\
    #<20171108><DZLIU>#                              "guess for fitting of Gaussians to an island of emission.\n"\
    #<20171108><DZLIU>#                              "If 'default', the number of Gaussians is "\
    #<20171108><DZLIU>#                              "estimated from the number of peaks in the island. An initial "\
    #<20171108><DZLIU>#                              "guess is made for the parameters of these Gaussians before "\
    #<20171108><DZLIU>#                              "final fitting is done. This method should produce the best "\
    #<20171108><DZLIU>#                              "results when there are no large sources present.\n"\
    #<20171108><DZLIU>#                              "If 'simple', the maximum allowable number of Gaussians per island "\
    #<20171108><DZLIU>#                              "is set to 25, and no initial guess for the gaussian parameters "\
    #<20171108><DZLIU>#                              "is made.\nLastly, the 'nobeam' method is similar to the "\
    #<20171108><DZLIU>#                              "'default' method, but no information about the beam is "\
    #<20171108><DZLIU>#                              "used. This method is best used when source sizes are "\
    #<20171108><DZLIU>#                              "expected to be very different from the beam and is generally "\
    #<20171108><DZLIU>#                              "slower than the other methods.\n"\
    #<20171108><DZLIU>#                              "For wavelet images, the value used for the original "\
    #<20171108><DZLIU>#                              "image is used for wavelet order j <= 3 and 'nobeam' for "\
    #<20171108><DZLIU>#                              "higher orders.",
    #<20171108><DZLIU>#                          group = "advanced_opts")
    #<20171108><DZLIU># --> changed "ini_gaussfit = Enum(" to "ini_gaussfit = String("
    ini_gausfit = String(\
