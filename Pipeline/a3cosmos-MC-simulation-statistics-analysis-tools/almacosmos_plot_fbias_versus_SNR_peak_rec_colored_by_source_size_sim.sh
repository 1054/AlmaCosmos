...
if [[ ! -f "datatable_applied_correction_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.txt" ]]; then
    topcat -stilts tmatchn nin=3 \
                            in1="datatable_applied_correction_fbias.txt" ifmt1=ascii \
                            in2="../simu_data_input_corrected.txt" ifmt2=ascii icmd2="keepcols \"S_in S_out noise\"" \
                            ...
                            ocmd="addcol S_peak \"S_out/source_area_per_beam\"" \
                            ocmd="addcol SNR_peak \"S_peak/noise\"" \
                            ocmd="addcol source_size_sim \"source_area_per_beam\"" \
                            ocmd="replacecol x2 \"source_area_per_beam\"" \
                            out="datatable_applied_correction_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.txt" ofmt=ascii
fi
...
topcat -stilts plot2plane \
                ...
                size1=1 \
                shading1=aux \
                in1='datatable_applied_correction_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.txt' \
                ifmt1=ascii \
                icmd1="sort x2" \
                leglabel1="$Data_type" \
                x1='SNR_peak' \
                y1='fbias' \
                \
                aux='x2' auxvisible=true auxmap=rainbow2 auxflip=true auxfunc=log auxlabel="x2 = sqrt(Area_{source}/Area_{beam})" auxmin=1.0  \
                \
                layer3=function \
                fexpr3='0.0' \
                color3=black \
                ...
                aspect=1.0 \
                omode=out \
                out='Plot_corrected_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.pdf'
...
echo "Output to \"Plot_corrected_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.pdf\"!"




convert -density 240 -geometry x800 "Plot_corrected_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.pdf" "Plot_corrected_fbias_versus_SNR_peak_rec_colored_by_source_size_sim.png"
