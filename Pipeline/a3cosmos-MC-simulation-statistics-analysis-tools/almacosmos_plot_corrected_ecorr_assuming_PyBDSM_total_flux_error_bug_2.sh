...
topcat -stilts plot2plane \
                ...
                ifmt1=ascii \
                icmd1='sort x2' \
                x1='S_out/(e_S_out_uncorr*((Maj_out*Min_out)/(Maj_beam*Min_beam)+1))' \
...
topcat -stilts plot2plane \
                ...
                ifmt1=ascii \
                icmd1='sort x2' \
                x1='(e_S_out_uncorr*((Maj_out*Min_out)/(Maj_beam*Min_beam)+1))' \
                y1='e_S_out_corr' \
                \
                aux='x2' auxvisible=true auxmap=rdbu auxflip=true auxlabel="Maj_{source}/Maj_{beam}" \
                \
...
topcat -stilts plot2plane \
                ...
                icmd1='sort x2' \
                x1='S_out/(e_S_out_uncorr*((Maj_out*Min_out)/(Maj_beam*Min_beam)+1))' \
                y1='(S_out/e_S_out_corr)/(S_out/(e_S_out_uncorr*((Maj_out*Min_out)/(Maj_beam*Min_beam)+1)))' \
                \
                aux='x2' auxvisible=true auxmap=rdbu auxflip=true auxlabel="Maj_{source}/Maj_{beam}" \
                \
                layer3=function \
