...
# Print usage
#if len(sys.argv) <= 1:
#    print('Usage: almacosmos_fit_simu_corr_fbias2_via_function.py simu_data_correction_table.txt')
...
y_obs = data_table.getColumn('cell_noi_median') # fbias2 is defined as cell_noi_mean = (S_in-S_out)/noise
...
with open('fitfun_table_fbias2.json', 'w') as fp:
    fp.write(fitfun_table_content)
print('Output to "fitfun_table_fbias2.json"!')
