...
# Initial guess
# 
initial_guess = (-3,3,-3, 3,3,-4, 0.1,3.0,0.05)
...
print(numpy.column_stack((numpy.array(['a1a','k1a','n1a','a1b','k1b','n1b','a2','k2','n2']),popt)))
print('')
#print(pcov)
...
def M_model(x1, x2, y_obs, y_err):
    ...
    #a1a = pymc.Uniform('a1', -50.0, +50.0, value = -1.0)
    #k1a = pymc.Uniform('k1',  +0.0, +50.0, value = +0.0) 
    #n1a = pymc.Uniform('n1', -50.0, +50.0, value = +0.0)
    a1a = pymc.Uniform('a1a',  -3.0,  +0.0, value = -3.0)
    k1a = pymc.Uniform('k1a',  +0.0, +3.0, value = +3.0) 
    n1a = pymc.Uniform('n1a',  -3.0, +0.0, value = -3.0)
    a1b = pymc.Uniform('a1b',  +0.0, +3.0, value = +3.0)
    k1b = pymc.Uniform('k1b', +0.0,  +3.0, value = +3.0)
    n1b = pymc.Uniform('n1b', -4.0,  +0.0, value = -4.0)
    a2 = pymc.Uniform('a2', -10.0, +10.0, value = +1.0)
    ...
    def M_func(x1=x1, x2=x2, a1a=a1a, k1a=k1a, n1a=n1a, a1b=a1b, k1b=k1b, n1b=n1b, a2=a2, k2=k2, n2=n2):
        #return a0 * (numpy.exp(a1*numpy.log10((x1/k1)**n1))) * (numpy.exp(a2*((x2/k2)**n2)))
        #return a0 * numpy.exp( -numpy.log10((x1/k1)**n1) ) * (a1 + a2*(x2/k2) + n2*(x2/k2)**2 + c2*(x2/k2)**3)
        return a1a*((numpy.log10(x1)/k1a)**n1a) + a1b*((numpy.log10(x1)/k1b)**n1b) * (a2 * (x2/k2)**n2)
    # 
...
popt_mean[0] = MDL.stats()['a1a']['mean']
popt_mean[1] = MDL.stats()['k1a']['mean']
popt_mean[2] = MDL.stats()['n1a']['mean']
popt_mean[3] = MDL.stats()['a1b']['mean']
popt_mean[4] = MDL.stats()['k1b']['mean']
popt_mean[5] = MDL.stats()['n1b']['mean']
popt_mean[6] = MDL.stats()['a2']['mean']
popt_mean[7] = MDL.stats()['k2']['mean']
popt_mean[8] = MDL.stats()['n2']['mean']
#popt_mean[7] = MDL.stats()['c2']['mean']
popt_min = copy(popt)
#popt_min[0] = MDL.stats()['a0']['quantiles'][2.5]
popt_min[0] = MDL.stats()['a1a']['quantiles'][2.5]
popt_min[1] = MDL.stats()['k1a']['quantiles'][2.5]
popt_min[2] = MDL.stats()['n1a']['quantiles'][2.5]
popt_min[3] = MDL.stats()['a1b']['quantiles'][2.5]
popt_min[4] = MDL.stats()['k1b']['quantiles'][2.5]
popt_min[5] = MDL.stats()['n1b']['quantiles'][2.5]
popt_min[6] = MDL.stats()['a2']['quantiles'][2.5]
popt_min[7] = MDL.stats()['k2']['quantiles'][2.5]
popt_min[8] = MDL.stats()['n2']['quantiles'][2.5]
#popt_min[7] = MDL.stats()['c2']['quantiles'][2.5]
popt_max = copy(popt)
#popt_max[0] = MDL.stats()['a0']['quantiles'][97.5]
popt_max[0] = MDL.stats()['a1a']['quantiles'][97.5]
popt_max[1] = MDL.stats()['k1a']['quantiles'][97.5]
popt_max[2] = MDL.stats()['n1a']['quantiles'][97.5]
popt_max[3] = MDL.stats()['a1b']['quantiles'][97.5]
popt_max[4] = MDL.stats()['k1b']['quantiles'][97.5]
popt_max[5] = MDL.stats()['n1b']['quantiles'][97.5]
popt_max[6] = MDL.stats()['a2']['quantiles'][97.5]
popt_max[7] = MDL.stats()['k2']['quantiles'][97.5]
popt_max[8] = MDL.stats()['n2']['quantiles'][97.5]
...
print(numpy.column_stack((numpy.array(['a1a','k1a','n1a','a1b','k1b','n1b','a2','k2','n2']),popt_mean)))
print('')
