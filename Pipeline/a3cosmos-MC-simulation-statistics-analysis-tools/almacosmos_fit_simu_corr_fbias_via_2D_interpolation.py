...
array_interpolated = interpolate.griddata(x_arr, y_arr, x_mesh, method='linear')
...
with open('interp_table_fbias.json', 'w') as fp:
    fp.write(table_content)
print('Output to "interp_table_fbias.json"!')
