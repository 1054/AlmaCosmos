...
#                    'datatable_applying_correction_fbias_via_spline_table.txt', Writer=asciitable.FixedWidth, delimiter=" ", 
#                    names=['x1', 'x2', 'array_extrapolated', 'array_interpolated', 'array_mask'], overwrite=True)
#
#print('Output to "datatable_applying_correction_fbias_via_spline_table.txt"!')
...
# combined fbias
# 
fbias = copy(array_interpolated)
#fbias = copy(array_extrapolated)
...
S_out_corr = S_out_uncorr / (1.0 - fbias)
S_out_corr[data_mask] = numpy.nan

asciitable.write(numpy.column_stack((S_out_corr, S_out_uncorr, fbias, x2, x1)), 
                    'datatable_applied_correction_fbias.txt', Writer=asciitable.FixedWidth, delimiter=" ", bookend=True, 
                    names=['S_out_corr','S_out_uncorr','fbias','x2','x1'], overwrite=True)
