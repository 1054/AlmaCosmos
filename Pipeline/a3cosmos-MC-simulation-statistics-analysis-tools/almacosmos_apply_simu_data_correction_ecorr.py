...
ecorr_array_extrapolated = numpy.power(10,ecorr_array_extrapolated)
ecorr_array_interpolated = numpy.power(10,ecorr_array_interpolated)
ecorr_array = numpy.power(10,ecorr_array)
...
e_S_out_corr = S_out_corr * (1/ecorr_from_function)

asciitable.write(numpy.column_stack((e_S_out_corr, e_S_out_uncorr, S_out_corr, S_out_uncorr, x2, x1)), 
                    'datatable_applied_correction_ecorr.txt', Writer=asciitable.FixedWidth, delimiter=" ", bookend=True, 
                    names=['e_S_out_corr','e_S_out_uncorr','S_out_corr','S_out_uncorr','x2','x1'], overwrite=True)
