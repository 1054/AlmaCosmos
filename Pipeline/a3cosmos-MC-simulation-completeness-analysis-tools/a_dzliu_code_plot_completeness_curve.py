...
# 
ax.plot(cumulative_curve['snr'], 1.0-cumulative_curve['incomp'], markerfacecolor='none', markeredgecolor=color_curve, marker='o', markersize=4, linestyle='none', label='Cumultaive')
