...
# Then we compute the spurious curve with our pipeline code, the default output is a folder named "spurious"

~/Cloud/Github/AlmaCosmos/Pipeline/a3cosmos-MC-simulation-spurious-analysis \
...
cp ~/Cloud/Github/AlmaCosmos/Pipeline/a3cosmos-MC-simulation-spurious-analysis-tools/a_dzliu_code_plot_spurious_curve.py \
.

./a_dzliu_code_plot_spurious_curve.py
