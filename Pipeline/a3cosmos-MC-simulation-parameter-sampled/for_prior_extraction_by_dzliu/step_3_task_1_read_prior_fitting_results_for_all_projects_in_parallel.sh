...
echo "cd $line; $(dirname ${BASH_SOURCE[0]})/step_3_task_1_read_prior_fitting_results_for_each_project.sh" >> list_of_commands_for_reading_prior_fitting_results.txt
done
fi
