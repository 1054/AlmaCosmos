...
for (( i=0; i<${#source_list[@]}; i++ )); do
    ...
    if [[ ${#source_zspec[@]} -gt 0 ]]; then
        echo "magphys_highz_go_a3cosmos_with_upper_limits_without_24um \"datatable_photometry_magphys.txt\" -redshift \"${source_zspec[@]}\"" >> "run_${SED_fitting_Type}_for_ID_${source_name}.sh"
        ...
        echo "magphys_highz_go_a3cosmos_with_upper_limits_without_24um \"datatable_photometry_magphys.txt\" -redshift \"${source_zprior[@]}\"" >> "run_${SED_fitting_Type}_for_ID_${source_name}.sh"
        echo "rm \"magphys_fitting/fit_1_with_datatable_photometry_magphys/fit_with_z\"* 2>/dev/null" >> "run_${SED_fitting_Type}_for_ID_${source_name}.sh"
